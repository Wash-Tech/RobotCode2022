...
private CANSparkMax storageConveyor2;
...
storageConveyor2 = new CANSparkMax(8, MotorType.kBrushed);
 
 storageConveyor2.restoreFactoryDefaults();  
storageConveyor2.setInverted(false);
storageConveyor2.setIdleMode(IdleMode.kCoast);
