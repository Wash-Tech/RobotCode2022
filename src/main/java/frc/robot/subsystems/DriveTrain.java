...
rightRearMC = new CANSparkMax(2, MotorType.kBrushless);
 ...
 rightRearMC.restoreFactoryDefaults();  
...
rightFrontMC = new CANSparkMax(3, MotorType.kBrushless);
 ...
 rightFrontMC.restoreFactoryDefaults();  
...
leftRearMC = new CANSparkMax(1, MotorType.kBrushless);
 ...
 leftRearMC.restoreFactoryDefaults();  
leftRearMC.setInverted(false);
leftRearMC.setIdleMode(IdleMode.kCoast);
  

leftFrontMC = new CANSparkMax(0, MotorType.kBrushless);
 
 leftFrontMC.restoreFactoryDefaults();  
